...
class Auth:
    def __init__(self) -> None:
        ...
        self.post_data = {"username": s.KEYCLOAK_USERNAME, "password": s.KEYCLOAK_PASSWORD}
    ...
    def get_token(self):
        ...
        try:
            ...
            tokens = session.post(s.KEYCLOAK_TOKEN, data=data).json()
...
if __name__ == "__main__":
    ...
    openid_configuration = requests.get(
        os.path.join(s.KEYCLOAK_URL, "realms", s.KEYCLOAK_REALM, ".well-known", "openid-configuration")
    ).json()
